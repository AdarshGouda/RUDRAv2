/*Create Date: 25-Apr-2021
  ...
  //Intent:  Integrate joy_msg. Create a subscriber.
  ...
  { // enter timed loop
    ...
    if (manual_mode) {
      ...
      if ((joy_Ly <=128) && (joy_Ly>=126)){
        ...
        if ((joy_Rx <=128) && (joy_Rx>=126)){

          joy_Rx = 0;
           
        }
        
        STRight.motor(1, map(joy_Ly-joy_Rx, 0,225,127,-127));
        STRight.motor(2, map(joy_Ly-joy_Rx, 0,225,127,-127));
        STLeft.motor(1, map(joy_Ly-joy_Rx, 0,225,127,-127));
        STLeft.motor(2, map(joy_Ly-joy_Rx, 0,225,127,-127));
